			...
			<div class="form-grids row widget-shadow" data-example-id="basic-forms">
				...
				<div class="form-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control1" id="title" placeholder="title" name="title" value="{{old('title')}}" required>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control1" id="title" placeholder="url" name="url" value="{{old('url')}}" required>
						</div>
						<div class="col-sm-2">
