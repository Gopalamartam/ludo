      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
       ...
       <!--    <li class="treeview">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="{{url('addquestionset')}}"><i class="fa fa-angle-right"></i> Add </a></li>
              <li><a href="{{url('viewquestionset')}}"><i class="fa fa-angle-right"></i> View </a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
          ...
          <li class="treeview">
            <a href="#">
              ...
              <span>Participant Users</span>
              <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="treeview-menu">
            
              <li><a href="{{url('participantuser')}}"><i class="fa fa-angle-right"></i> View </a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
