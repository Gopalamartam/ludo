    ...
    <script src="{{url('public/admin')}}/js/Chart.bundle.js"></script>
	...
	<script src="{{url('public/admin')}}/js/SimpleChart.js"></script>
    <script>
        var graphdata1 = {
            linecolor: "#CCA300",
            title: "Monday",
   ...
   <script src="{{url('public/admin')}}/js/bootstrap.js"> </script>
	...
	<!-- for amcharts js -->
  <script src="{{url('public/admin')}}/js/amcharts.js"></script>
			<script src="{{url('public/admin')}}/js/serial.js"></script>
			<script src="{{url('public/admin')}}/js/export.min.js"></script>
			<link rel="stylesheet" href="css/export.css" type="text/css" media="all" />
			<script src="{{url('public/admin')}}/js/light.js"></script>
	<!-- for amcharts js -->
