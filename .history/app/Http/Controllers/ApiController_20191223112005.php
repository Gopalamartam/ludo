...
class ApiController extends Controller
{
	...
	public function getQuestion(Request $request)
	{
		...
		foreach ($questiontoday as $key => $value) {
			...
			$result[$key]['question'] = $value1->question;
			$result[$key]['option1'] = $value1->option1;
			$result[$key]['option2'] = $value1->option2;
			$result[$key]['option3'] = $value1->option3;
			$result[$key]['option4'] = $value1->option4;
