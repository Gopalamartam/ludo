...
class QuestionController extends Controller
{
    ...
    public function participantuser()
    {
        ...
        $leads = DB::table('user_questions')
        ->leftJoin('orders', 'orders.id', '=', 'user_questions.process_status')
        ->leftJoin('categories', 'categories.id', '=', 'leads.category_id')
        ->leftJoin('sources', 'sources.id', '=', 'leads.source_id')
        ->leftJoin('user_details', 'user_details.user_id', '=', 'leads.user_id')
        ->leftJoin('technologies', 'technologies.id', '=', 'leads.technology_id')
        ->leftJoin('assigns', 'assigns.lead_id', '=', 'leads.id');
