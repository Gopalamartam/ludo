...
class QuestionController extends Controller
{
    ...
    public function participantuser()
    {
        ...
        ->leftJoin('quizzes', 'quizzes.id', '=', 'user_questions.quiz')
        ->leftJoin('questions', 'questions.id', '=', 'user_questions.question_id')
        ->leftJoin('users', 'users.id', '=', 'user_questions.user_id');
        $userquestion = $userquestion->select( 'orders.*', 'users.*', 'user_questions.*','quizzes.title as title','questions.question')
        ->get();
      
        return view("question.participantuser",compact("userquestion"));
    }
