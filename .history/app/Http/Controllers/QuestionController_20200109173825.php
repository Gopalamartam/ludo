...
class QuestionController extends Controller
{
    ...
    public function participantuser()
    {
        ...
        $questionData=UserQuestion::where("status","!=",0);
        $questionData=$questionData->leftJoin("orders");
        ...
        $userquestion = $userquestion->select(DB::raw('group_concat(assigns.user_id) as assignusers'), 'leads.*', 'statuses.name as status', 'categories.name as category_name', 'sources.name as source_name', 'technologies.name as technology_name', 'assigns.user_id as assign_user', 'assigns.created_at as assignscreated_at', 'user_details.fname', 'user_details.lname', 'user_details.country')
        ->get();
