...
/*Route::middleware('auth:api')->get('/user', function (Request $request) {
 ...
 Route::post('battingRequest', 'ApiController@battingRequest');
  ...
  Route::post('myBatting', 'ApiController@myBatting');
    Route::post('howplay', 'ApiController@howplay');
  ...
  Route::get('pay/{orderId}', 'ApiController@payamount');
  Route::post('paymentresponse', 'ApiController@paymentresponse');
  Route::any('orderstatus/{status}', 'ApiController@orderstatus');
  Route::any('sendFeedback/', 'ApiController@sendFeedback');
  Route::any('gethash/', 'ApiController@gethash');
  Route::any('responsehash/', 'ApiController@responsehash');
